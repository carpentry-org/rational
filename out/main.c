...
// Depth 4
typedef int(*Fn__float_MUL__int)(float*);
...
// Depth 6
typedef Rational(*Fn__Rational_MUL__Rational_MUL__Rational)(Rational*, Rational*);

// Depth 6
typedef bool(*Fn__Rational_MUL__Rational_MUL__bool)(Rational*, Rational*);

// Depth 6
typedef String(*Fn__Rational_MUL__String)(Rational*);

// Depth 6
typedef double(*Fn__Rational_MUL__double)(Rational*);

// Depth 6
typedef float(*Fn__Rational_MUL__float)(Rational*);

// Depth 6
typedef int(*Fn__Rational_MUL__int)(Rational*);

// Depth 6
typedef int*(*Fn__Rational_MUL__int_MUL_)(Rational*);
...
// Depth 6
typedef Rational(*Fn__double_Rational)(double);

// Depth 6
typedef Maybe__float(*Fn__float_Maybe__float)(float);

// Depth 6
typedef Rational(*Fn__float_Rational)(float);

// Depth 6
typedef Maybe__int(*Fn__int_Maybe__int)(int);

// Depth 6
typedef Rational(*Fn__int_Rational)(int);

// Depth 6
typedef Rational(*Fn__int_int_Rational)(int, int);
...
// Depth 505
typedef TestState(*Fn__TestState_MUL__Rational_MUL__Rational_MUL__String_MUL__String_MUL__Fn__Rational_MUL__Rational_MUL__bool_TestState)(TestState*, Rational*, Rational*, String*, String*, Lambda);

// Depth 505
typedef TestState(*Fn__TestState_MUL__Rational_MUL__Rational_MUL__String_MUL__String_MUL__bool_TestState)(TestState*, Rational*, Rational*, String*, String*, bool);

// Depth 505
typedef TestState(*Fn__TestState_MUL__Rational_MUL__Rational_MUL__String_MUL__TestState)(TestState*, Rational*, Rational*, String*);
...
// Depth 505
typedef TestState(*Fn__TestState_MUL__float_float_String_MUL__String_MUL__bool_TestState)(TestState*, float, float, String*, String*, bool);

// Depth 505
typedef TestState(*Fn__TestState_MUL__float_float_String_MUL__TestState)(TestState*, float, float, String*);
...
// Depth 500
void Function_delete__Rational_MUL__Rational_MUL__bool (Lambda f);
...
// Depth 500
bool Rational__EQ_(Rational* a, Rational* b);

// Depth 500
Rational Rational_add(Rational* a, Rational* b);

// Depth 500
Rational Rational_copy(Rational* pRef);

// Depth 500
void Rational_delete(Rational p);

// Depth 500
int* Rational_denominator(Rational* p);

// Depth 500
Rational Rational_div(Rational* a, Rational* b);

// Depth 500
Rational Rational_from_MINUS_double(double f);

// Depth 500
Rational Rational_from_MINUS_float(float f);

// Depth 500
Rational Rational_from_MINUS_int(int i);

// Depth 500
int Rational_gcd(int a, int b);

// Depth 500
int Rational_hash(Rational* r);

// Depth 500
Rational Rational_init(int numerator, int denominator);

// Depth 500
Rational Rational_modulo(Rational* a, Rational* b);

// Depth 500
Rational Rational_mul(Rational* a, Rational* b);

// Depth 500
Rational Rational_new(int n, int d);

// Depth 500
int* Rational_numerator(Rational* p);

// Depth 500
String Rational_prn(Rational *p);

// Depth 500
Rational Rational_set_MINUS_denominator(Rational p, int newValue);

// Depth 500
void Rational_set_MINUS_denominator_BANG_(Rational* pRef, int newValue);

// Depth 500
Rational Rational_set_MINUS_numerator(Rational p, int newValue);

// Depth 500
void Rational_set_MINUS_numerator_BANG_(Rational* pRef, int newValue);

// Depth 500
String Rational_str(Rational* r);

// Depth 500
Rational Rational_sub(Rational* a, Rational* b);

// Depth 500
double Rational_to_MINUS_double(Rational* r);

// Depth 500
float Rational_to_MINUS_float(Rational* r);

// Depth 500
int Rational_to_MINUS_int(Rational* r);

// Depth 500
Rational Rational_update_MINUS_denominator(Rational p, Lambda *updater);

// Depth 500
Rational Rational_update_MINUS_numerator(Rational p, Lambda *updater);
...
// Depth 500
TestState Test_assert_MINUS_equal__Rational_MUL__String(TestState* state, Rational* x, Rational* y, String* descr);
...
// Depth 500
TestState Test_display_MINUS_test__Rational_MUL__Rational_MUL__String_String(TestState* state, Rational* expected, Rational* actual, String* descr, String* what, bool is_MINUS_success);
...
// Depth 500
TestState Test_handler__Rational_MUL__Rational_MUL__String_String(TestState* state, Rational* expected, Rational* actual, String* descr, String* what, Lambda op);
...
bool Rational__EQ_(Rational* a, Rational* b) {
    bool _27;
    int* _9 = Rational_numerator(a);
    int* _12 = Rational_numerator(b);
    bool _13 = IntRef__EQ_(_9, _12);
    if (_13) {
        int* _18 = Rational_denominator(a);
        int* _21 = Rational_denominator(b);
        bool _22 = IntRef__EQ_(_18, _21);
        bool _23 = _22;
        _27 = _23;
    } else {
        bool _26 = false;
...
Rational Rational_add(Rational* a, Rational* b) {
    Rational _51;
    /* let */ {
        int* _10 = Rational_numerator(a);
        int _11 = Int_copy(_10);
        int na = _11;
        int* _16 = Rational_numerator(b);
        int _17 = Int_copy(_16);
        int nb = _17;
        int* _22 = Rational_denominator(a);
        int _23 = Int_copy(_22);
        int da = _23;
        int* _28 = Rational_denominator(b);
        int _29 = Int_copy(_28);
        int db = _29;
        int _35 = Int__MUL_(na, db);
        int _39 = Int__MUL_(nb, da);
        int _40 = Int__PLUS_(_35, _39);
        int n = _40;
        int _45 = Int__MUL_(da, db);
        int d = _45;
        Rational _50 = Rational_new(n, d);
        _51 = _50;
    }
    return _51;
}
...
Rational Rational_copy(Rational* pRef) {
    Rational copy = *pRef;
    /* Ignore non-managed member 'numerator' : Int */
    /* Ignore non-managed member 'denominator' : Int */
    return copy;
}
...
int* Rational_denominator(Rational* p) { return (&(p->denominator)); }
...
Rational Rational_div(Rational* a, Rational* b) {
    ...
    /* let */ {
        ...
        int _29 = Int_copy(_28);
        int db = _29;
        int _34 = Int__DIV_(na, db);
        int n = _34;
        int _39 = Int__MUL_(da, nb);
        int d = _39;
        Rational _44 = Rational_new(n, d);
        _45 = _44;
    }
    return _45;
}
...
Rational Rational_from_MINUS_double(double f) {
    ...
    /* let */ {
        int t = 1;
        double t2 = f;
        int _18 = Double_to_MINUS_int(t2);
        double _19 = Double_from_MINUS_int(_18);
        bool _20 = Double_approx__double(t2, _19);
        bool _21 = not(_20);
        bool _40 = _21;
        while (_40) {
            int _28 = Int__MUL_(t, 10);
            t = _28;  // Int = Int
            double _36 = Double_from_MINUS_int(t);
            double _37 = Double__MUL_(f, _36);
            t2 = _37;  // Double = Double
            int _18 = Double_to_MINUS_int(t2);
            double _19 = Double_from_MINUS_int(_18);
            bool _20 = Double_approx__double(t2, _19);
            bool _21 = not(_20);
        ...
        Rational _67;
        /* let */ {
            double _48 = Double_from_MINUS_int(t);
            double _49 = Double__MUL_(f, _48);
            int _50 = Double_to_MINUS_int(_49);
            int fk = _50;
            int _55 = Rational_gcd(fk, t);
            int k = _55;
            int _61 = Int__DIV_(fk, k);
            int _65 = Int__DIV_(t, k);
            Rational _66 = Rational_new(_61, _65);
            _67 = _66;
        }
        Rational _68 = _67;
        _69 = _68;
...
Rational Rational_from_MINUS_float(float f) {
    ...
    /* let */ {
        int t = 1;
        float t2 = f;
        int _17 = Float_to_MINUS_int(t2);
        float _18 = Float_from_MINUS_int(_17);
        bool _19 = _DIV__EQ___float(t2, _18);
        bool _38 = _19;
        while (_38) {
            int _26 = Int__MUL_(t, 10);
            t = _26;  // Int = Int
            float _34 = Float_from_MINUS_int(t);
            float _35 = Float__MUL_(f, _34);
            t2 = _35;  // Float = Float
            int _17 = Float_to_MINUS_int(t2);
            float _18 = Float_from_MINUS_int(_17);
            bool _19 = _DIV__EQ___float(t2, _18);
        ...
        Rational _65;
        /* let */ {
            float _46 = Float_from_MINUS_int(t);
            float _47 = Float__MUL_(f, _46);
            int _48 = Float_to_MINUS_int(_47);
            int fk = _48;
            int _53 = Rational_gcd(fk, t);
            int k = _53;
            int _59 = Int__DIV_(fk, k);
            int _63 = Int__DIV_(t, k);
            Rational _64 = Rational_new(_59, _63);
            _65 = _64;
        }
        Rational _66 = _65;
        _67 = _66;
...
Rational Rational_from_MINUS_int(int i) {
    Rational _7 = Rational_init(i, 1);
    return _7;
}

int Rational_gcd(int a, int b) {
    while(1) {
        bool _9 = Int__EQ_(b, 0);
        if (_9) {
            return a;
        } else {
            int _19 = Int_mod(a, b);
...
int Rational_hash(Rational* r) {
    int _29;
    int* _10 = Rational_denominator(r);
    int _11 = Int_copy(_10);
    bool _12 = Int__EQ_(1, _11);
    if (_12) {
        int* _17 = Rational_numerator(r);
        int _18 = Int_hash(_17);
        int _19 = _18;
        _29 = _19;
    } else {
        float _25 = Rational_to_MINUS_float(r);
        float* _26 = &_25; // ref
        int _27 = Float_hash(_26);
        int _28 = _27;
        _29 = _28;
    }
    return _29;
...
Rational Rational_modulo(Rational* a, Rational* b) {
    ...
    /* let */ {
        ...
        int _29 = Int_copy(_28);
        int db = _29;
        int _36 = Int__MUL_(na, db);
        int _40 = Int__MUL_(nb, da);
        int _41 = Int__DIV_(_36, _40);
        Rational _42 = Rational_from_MINUS_int(_41);
        Rational n = _42;
        Rational* _50 = &n; // ref
        Rational _52 = Rational_mul(_50, b);
        Rational* _53 = &_52; // ref
        Rational _54 = Rational_sub(a, _53);
        _55 = _54;
        Rational_delete(_52);
        Rational_delete(n);
    }
...
Rational Rational_mul(Rational* a, Rational* b) {
    ...
    /* let */ {
        ...
        int _29 = Int_copy(_28);
        int db = _29;
        int _34 = Int__MUL_(na, nb);
        int n = _34;
        int _39 = Int__MUL_(da, db);
        int d = _39;
        Rational _44 = Rational_new(n, d);
        _45 = _44;
    }
...
Rational Rational_new(int n, int d) {
    Rational _22;
    /* let */ {
        int _10 = Rational_gcd(n, d);
        int g = _10;
        int _16 = Int__DIV_(n, g);
        int _20 = Int__DIV_(d, g);
        Rational _21 = Rational_init(_16, _20);
        _22 = _21;
    }
    return _22;
}

int* Rational_numerator(Rational* p) { return (&(p->numerator)); }
...
String Rational_prn(Rational *p) {
  ...
  int tempsize = 0;
  (void)tempsize; // that way we remove the occasional unused warning 
  int size = snprintf(NULL, 0, "(%s )", "Rational");
  temp = Int_prn(p->numerator); 
  size += snprintf(NULL, 0, "%s ", temp);
  if(temp) { CARP_FREE(temp); temp = NULL; }

  temp = Int_prn(p->denominator); 
  size += snprintf(NULL, 0, "%s ", temp);
  if(temp) { CARP_FREE(temp); temp = NULL; }
  ...
  bufferPtr += snprintf(bufferPtr, size - (bufferPtr - buffer), "(%s ", "Rational");
  temp = Int_prn(p->numerator);
  tempsize = snprintf(bufferPtr, size - (bufferPtr - buffer), "%s ", temp);
  bufferPtr += tempsize;
  if(temp) { CARP_FREE(temp); temp = NULL; }
...
void Rational_set_MINUS_denominator_BANG_(Rational* pRef, int newValue) {
    /* Ignore non-managed member 'denominator' : Int */
    pRef->denominator = newValue;
}


Rational Rational_set_MINUS_numerator(Rational p, int newValue) {
    /* Ignore non-managed member 'numerator' : Int */
    p.numerator = newValue;
    return p;
}
...
void Rational_set_MINUS_numerator_BANG_(Rational* pRef, int newValue) {
    /* Ignore non-managed member 'numerator' : Int */
    pRef->numerator = newValue;
}


String Rational_str(Rational* r) {
    static String _9 = "(Rational %d/";
    String *_9_ref = &_9;
    int* _13 = Rational_numerator(r);
    int _14 = Int_copy(_13);
    String _1000007 = Int_format(_9_ref, _14);
    String* _1000005 = &_1000007; // ref
    static String _19 = "%d)";
    String *_19_ref = &_19;
    int* _23 = Rational_denominator(r);
    int _24 = Int_copy(_23);
    String _1000010 = Int_format(_19_ref, _24);
    String* _1000008 = &_1000010; // ref
    String _1000004 = String_append(_1000005, _1000008);
    String* _1000002 = &_1000004; // ref
    String _29 = String_copy(_1000002);
    String_delete(_1000004);
    String_delete(_1000007);
    String_delete(_1000010);
    return _29;
...
double Rational_to_MINUS_double(Rational* r) {
    int* _9 = Rational_numerator(r);
    int _10 = Int_copy(_9);
    double _11 = Double_from_MINUS_int(_10);
    int* _16 = Rational_denominator(r);
    int _17 = Int_copy(_16);
    double _18 = Double_from_MINUS_int(_17);
    double _19 = Double__DIV_(_11, _18);
    return _19;
}
...
float Rational_to_MINUS_float(Rational* r) {
    int* _9 = Rational_numerator(r);
    int _10 = Int_copy(_9);
    float _11 = Float_from_MINUS_int(_10);
    int* _16 = Rational_denominator(r);
    int _17 = Int_copy(_16);
    float _18 = Float_from_MINUS_int(_17);
    float _19 = Float__DIV_(_11, _18);
    return _19;
}

int Rational_to_MINUS_int(Rational* r) {
    int* _8 = Rational_numerator(r);
    int _9 = Int_copy(_8);
    int* _13 = Rational_denominator(r);
    int _14 = Int_copy(_13);
    int _15 = Int__DIV_(_9, _14);
    return _15;
}

Rational Rational_update_MINUS_denominator(Rational p, Lambda *updater) {
    p.denominator = (*updater).env ? ((Fn__LambdaEnv_int_int)(*updater).callback)((*updater).env, p.denominator) : ((Fn__int_int)(*updater).callback)(p.denominator);
    return p;
}


Rational Rational_update_MINUS_numerator(Rational p, Lambda *updater) {
    p.numerator = (*updater).env ? ((Fn__LambdaEnv_int_int)(*updater).callback)((*updater).env, p.numerator) : ((Fn__int_int)(*updater).callback)(p.numerator);
    return p;
}
...
Rational Rational_zero() {
    int _5 = Int_zero();
    int _7 = Int_zero();
    Rational _8 = Rational_init(_5, _7);
    return _8;
}
...
TestState Test_assert_MINUS_equal__Rational_MUL__String(TestState* state, Rational* x, Rational* y, String* descr) {
    ...
    String *_12_ref = &_12;
    Lambda _13 = { .callback = (void*)Rational__EQ_, .env = NULL, .delete = NULL, .copy = NULL }; //Sym Rational.= (LookupGlobal CarpLand AFunction)
    TestState _14 = Test_handler__Rational_MUL__Rational_MUL__String_String(state, x, y, descr, _12_ref, _13);
    return _14;
}
...
TestState Test_assert_MINUS_equal__float_String(TestState* state, float x, float y, String* descr) {
    static String _12 = "value";
    String *_12_ref = &_12;
    Lambda _13 = { .callback = (void*)Float__EQ_, .env = NULL, .delete = NULL, .copy = NULL }; //Sym Float.= (LookupGlobal ExternalCode AFunction)
    TestState _14 = Test_handler__float_float_String_String(state, x, y, descr, _12_ref, _13);
    return _14;
}
...
TestState Test_display_MINUS_test__Rational_MUL__Rational_MUL__String_String(TestState* state, Rational* expected, Rational* actual, String* descr, String* what, bool is_MINUS_success) {
    ...
    if (is_MINUS_success) {
        ...
        IO_print(_131);
        String _137 = Rational_str(expected);
        ...
        String _158 = Rational_str(actual);
...
TestState Test_display_MINUS_test__float_float_String_String(TestState* state, float expected, float actual, String* descr, String* what, bool is_MINUS_success) {
    ...
    if (is_MINUS_success) {
        ...
        String* _131 = &_1000027; // ref
        IO_print(_131);
        String _137 = Float_str(expected);
        String* _138 = &_137; // ref
        IO_print(_138);
        static String _148 = "', actual value: '";
        String *_148_ref = &_148;
...
TestState Test_handler__Rational_MUL__Rational_MUL__String_String(TestState* state, Rational* expected, Rational* actual, String* descr, String* what, Lambda op) {
    bool _18 = op.env ? ((bool(*)(LambdaEnv, Rational*, Rational*))op.callback)(op.env, expected, actual) : ((bool(*)(Rational*, Rational*))op.callback)(expected, actual);
    TestState _19 = Test_display_MINUS_test__Rational_MUL__Rational_MUL__String_String(state, expected, actual, descr, what, _18);
    Function_delete__Rational_MUL__Rational_MUL__bool(op);
    return _19;
}
...
TestState Test_handler__float_float_String_String(TestState* state, float expected, float actual, String* descr, String* what, Lambda op) {
    bool _18 = op.env ? ((bool(*)(LambdaEnv, float, float))op.callback)(op.env, expected, actual) : ((bool(*)(float, float))op.callback)(expected, actual);
    TestState _19 = Test_display_MINUS_test__float_float_String_String(state, expected, actual, descr, what, _18);
    Function_delete__float_float_bool(op);
    return _19;
}
...
int main(int argc, char** argv) {
    ...
    /* let */ {
        ...
        Rational _22 = Rational_new(1, 4);
        Rational* _23 = &_22; // ref
        Rational _27 = Rational_from_MINUS_float(0.25f);
        Rational* _28 = &_27; // ref
        static String _29 = "can convert correctly from float";
        String *_29_ref = &_29;
        TestState _30 = Test_assert_MINUS_equal__Rational_MUL__String(test, _23, _28, _29_ref);
        TestState* _1000010 = &_30; // ref
        test = _1000010;  // (Ref Test.State r190) = (Ref Test.State r190)
        Rational _44 = Rational_new(1, 4);
        Rational* _45 = &_44; // ref
        float _46 = Rational_to_MINUS_float(_45);
        static String _47 = "can convert correctly to float";
        String *_47_ref = &_47;
        TestState _48 = Test_assert_MINUS_equal__float_String(test, 0.25f, _46, _47_ref);
        TestState* _1000013 = &_48; // ref
        test = _1000013;  // (Ref Test.State r190) = (Ref Test.State r190)
        Rational _60 = Rational_new(1, 4);
        Rational* _61 = &_60; // ref
        Rational _65 = Rational_from_MINUS_double(0.25);
        Rational* _66 = &_65; // ref
        static String _67 = "can convert correctly from double";
        String *_67_ref = &_67;
        TestState _68 = Test_assert_MINUS_equal__Rational_MUL__String(test, _61, _66, _67_ref);
        TestState* _1000016 = &_68; // ref
        test = _1000016;  // (Ref Test.State r190) = (Ref Test.State r190)
        Rational _82 = Rational_new(1, 4);
        Rational* _83 = &_82; // ref
        double _84 = Rational_to_MINUS_double(_83);
        static String _85 = "can convert correctly to double";
        String *_85_ref = &_85;
        TestState _86 = Test_assert_MINUS_equal__double_String(test, 0.25, _84, _85_ref);
        TestState* _1000019 = &_86; // ref
        test = _1000019;  // (Ref Test.State r190) = (Ref Test.State r190)
        Rational _98 = Rational_new(12, 1);
        Rational* _99 = &_98; // ref
        Rational _103 = Rational_from_MINUS_int(12);
        Rational* _104 = &_103; // ref
        static String _105 = "can convert correctly from int";
        String *_105_ref = &_105;
        TestState _106 = Test_assert_MINUS_equal__Rational_MUL__String(test, _99, _104, _105_ref);
        TestState* _1000022 = &_106; // ref
        test = _1000022;  // (Ref Test.State r190) = (Ref Test.State r190)
        Rational _120 = Rational_new(1, 1);
        Rational* _121 = &_120; // ref
        int _122 = Rational_to_MINUS_int(_121);
        static String _123 = "can convert correctly to int";
        String *_123_ref = &_123;
        TestState _124 = Test_assert_MINUS_equal__int_String(test, 1, _122, _123_ref);
        TestState* _1000025 = &_124; // ref
        test = _1000025;  // (Ref Test.State r190) = (Ref Test.State r190)
        Rational _136 = Rational_new(11, 18);
        Rational* _137 = &_136; // ref
        Rational _144 = Rational_new(1, 9);
        Rational* _145 = &_144; // ref
        Rational _150 = Rational_new(3, 6);
        Rational* _151 = &_150; // ref
        Rational _152 = Rational_add(_145, _151);
        Rational* _153 = &_152; // ref
        static String _154 = "can add correctly";
        String *_154_ref = &_154;
        TestState _155 = Test_assert_MINUS_equal__Rational_MUL__String(test, _137, _153, _154_ref);
        TestState* _1000028 = &_155; // ref
        test = _1000028;  // (Ref Test.State r190) = (Ref Test.State r190)
        Rational _167 = Rational_new(5, 3);
        Rational* _168 = &_167; // ref
        Rational _175 = Rational_new(6, 3);
        Rational* _176 = &_175; // ref
        Rational _181 = Rational_new(2, 6);
        Rational* _182 = &_181; // ref
        Rational _183 = Rational_sub(_176, _182);
        Rational* _184 = &_183; // ref
        static String _185 = "can subtract correctly";
        String *_185_ref = &_185;
        TestState _186 = Test_assert_MINUS_equal__Rational_MUL__String(test, _168, _184, _185_ref);
        TestState* _1000031 = &_186; // ref
        test = _1000031;  // (Ref Test.State r190) = (Ref Test.State r190)
        Rational _198 = Rational_new(3, 4);
        Rational* _199 = &_198; // ref
        Rational _206 = Rational_new(3, 1);
        Rational* _207 = &_206; // ref
        Rational _212 = Rational_new(8, 2);
        Rational* _213 = &_212; // ref
        Rational _214 = Rational_div(_207, _213);
        Rational* _215 = &_214; // ref
        static String _216 = "can divide correctly";
        String *_216_ref = &_216;
        TestState _217 = Test_assert_MINUS_equal__Rational_MUL__String(test, _199, _215, _216_ref);
        TestState* _1000034 = &_217; // ref
        test = _1000034;  // (Ref Test.State r190) = (Ref Test.State r190)
        Rational _229 = Rational_new(3, 16);
        Rational* _230 = &_229; // ref
        Rational _237 = Rational_new(1, 8);
        Rational* _238 = &_237; // ref
        Rational _243 = Rational_new(3, 2);
        Rational* _244 = &_243; // ref
        Rational _245 = Rational_mul(_238, _244);
        Rational* _246 = &_245; // ref
        static String _247 = "can multiply correctly";
        String *_247_ref = &_247;
        TestState _248 = Test_assert_MINUS_equal__Rational_MUL__String(test, _230, _246, _247_ref);
        TestState* _1000037 = &_248; // ref
        test = _1000037;  // (Ref Test.State r190) = (Ref Test.State r190)
        Rational _260 = Rational_new(3, 20);
        Rational* _261 = &_260; // ref
        Rational _268 = Rational_new(12, 5);
        Rational* _269 = &_268; // ref
        Rational _274 = Rational_new(3, 4);
        Rational* _275 = &_274; // ref
        Rational _276 = Rational_modulo(_269, _275);
        Rational* _277 = &_276; // ref
        static String _278 = "can modulo correctly";
        String *_278_ref = &_278;
        TestState _279 = Test_assert_MINUS_equal__Rational_MUL__String(test, _261, _277, _278_ref);
        TestState* _1000040 = &_279; // ref
        test = _1000040;  // (Ref Test.State r190) = (Ref Test.State r190)
        static String _287 = "(Rational 3/2)";
        String *_287_ref = &_287;
        Rational _294 = Rational_new(3, 2);
        Rational* _295 = &_294; // ref
        String _296 = Rational_str(_295);
        String* _297 = &_296; // ref
        static String _298 = "can stringify";
        String *_298_ref = &_298;
        TestState _299 = Test_assert_MINUS_equal__String_MUL__String(test, _287_ref, _297, _298_ref);
        TestState* _1000043 = &_299; // ref
        test = _1000043;  // (Ref Test.State r190) = (Ref Test.State r190)
        Rational _313 = Rational_new(12, 1);
        Rational* _314 = &_313; // ref
        int _315 = Rational_hash(_314);
        static String _316 = "can hash";
        String *_316_ref = &_316;
        TestState _317 = Test_assert_MINUS_equal__int_String(test, 12, _315, _316_ref);
        TestState* _1000046 = &_317; // ref
        test = _1000046;  // (Ref Test.State r190) = (Ref Test.State r190)
        Test_print_MINUS_test_MINUS_results(test);
        int* _1000049 = Test_State_failed(test);
        int _1000048 = Int_copy(_1000049);
        int _1000006 = _1000048;
        _1000002 = _1000006;
        Rational_delete(_103);
        Rational_delete(_120);
        Rational_delete(_136);
        Rational_delete(_144);
        Rational_delete(_150);
        Rational_delete(_152);
        Rational_delete(_167);
        Rational_delete(_175);
        Rational_delete(_181);
        Rational_delete(_183);
        Rational_delete(_198);
        Rational_delete(_206);
        Rational_delete(_212);
        Rational_delete(_214);
        Rational_delete(_22);
        Rational_delete(_229);
        Rational_delete(_237);
        Rational_delete(_243);
        Rational_delete(_245);
        Rational_delete(_260);
        Rational_delete(_268);
        Rational_delete(_27);
        Rational_delete(_274);
        Rational_delete(_276);
        Rational_delete(_294);
        Rational_delete(_313);
        Rational_delete(_44);
        Rational_delete(_60);
        Rational_delete(_65);
        Rational_delete(_82);
        ...
        Test_State_delete(_106);
        Test_State_delete(_124);
        Test_State_delete(_155);
        Test_State_delete(_186);
        Test_State_delete(_217);
        Test_State_delete(_248);
        Test_State_delete(_279);
        Test_State_delete(_299);
        Test_State_delete(_30);
        Test_State_delete(_317);
        Test_State_delete(_48);
        Test_State_delete(_68);
        Test_State_delete(_86);
    }
    return _1000002;
}
